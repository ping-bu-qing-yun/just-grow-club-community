...
| 用户想参加活动 | 用户担心活动尴尬、流程不清楚、人数不合适、像相亲 | 活动平台更关注报名转化，不够解释“这场见面为什么适合你” |
| 小CC做活动 | 她需要从大量聊天、评论、反馈里判断大家到底想要什么 | 普通表单只能收集答案，不能转化为可执行活动提案 |
...
1. 用户先从欢迎页进入，阅读小CC的介绍信，理解“这里不是催促你脱单，而是先确认你舒服的见面方式”。
2. 用户完成轻问答、基础资料和关系画像生成，系统沉淀“怕尴尬、少人数、慢热、想认真认识”等标签。
3. 首页根据画像推荐更合适的活动和需求卡，而不是让用户盲目浏览。
4. 用户可以报名成熟活动、预约预活动、捡漏满员活动、取消报名并说明原因。
5. 用户也可以发布需求或生活动态，让小CC看到真实的关系表达。
6. 小CC在运营工作台看到需求分类、AI活动提案、每日待办、经营明细、活动管理和消息提醒。
