...
import App from '../App';
import { formatActivityDateLabel } from './CreateActivityPage';

beforeEach(() => window.localStorage.clear());

describe('formatActivityDateLabel', () => {
  it('formats ISO date as weekday and month-day label', () => {
    // 2026-08-09 is Sunday
    expect(formatActivityDateLabel('2026-08-09')).toBe('周日 · 8月9日');
  });
});
...
it('validates required fields and publishes from the central plus menu', async () => {
  ...
  await user.type(screen.getByLabelText('日期'), '2026-08-09');
