...
import { ArrowLeft, Archive, Check, RotateCcw, ShieldAlert, X } from 'lucide-react';
import { api } from '../api/client';
import type { AdminContentItem, ApiContentTag, ContentStatus, ContentType } from '../api/types';
import { useQiahao } from '../state/QiahaoContext';

const statusLabels: Record<ContentStatus, string> = { draft: '草稿', pending: '待审核', approved: '已通过', rejected: '已驳回', archived: '已归档' };
