...
function renderCenter() {
  return render(<QiahaoProvider><NotificationsProvider><NotificationCenterPage onBack={vi.fn()} onOpen={vi.fn()} /></NotificationsProvider></QiahaoProvider>);
}

beforeEach(() => window.localStorage.clear());

it('filters notifications and clears only read entries', async () => {
